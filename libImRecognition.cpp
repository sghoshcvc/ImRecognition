...
#include <stdio.h>
#define EXPORTING_libImRecognition 1
  ...
  if (!mclmcrInitialize())
    return false;
    {
        mclCtfStream ctfStream = 
            mclGetEmbeddedCtfStream((void *)(libImRecognitionInitializeWithHandlers));
        if (ctfStream) {
...
{
  return libImRecognitionInitializeWithHandlers(mclDefaultErrorHandler, 
